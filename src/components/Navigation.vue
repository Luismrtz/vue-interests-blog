<template>
  <header>
    <div class="container">
      <div class="title">
        <router-link class="linkTitle" :to="{ name: 'Home' }"
          ><h2>PinBlogs</h2></router-link
        >
      </div>
      <div class="navLinks" v-show="!mobile">
        ...
        >
        <router-link class="link" :to="{ name: 'BlogPage' }"
          ><h3>Blogs</h3></router-link
        >

        <router-link v-if="!user" class="link" :to="{ name: 'Login' }"
          ><h3>Login/Register</h3></router-link
        >
        <div v-if="user" class="hover-box">
          <h3 class="link">
            Sign Out &nbsp;<fa :icon="['fas', 'arrow-down']" />
          </h3>
    ...
    >
      <ul class="mobile-nav" v-show="mobileNav">
        ...
        <router-link
          v-if="user"
          @click="[signOutFunc, toggleMobileNav]"
          class="link mobileLink sign-out"
          to="#"
